...
function PositionsList(){
    return(
        <div className="mx-auto lg:mx-12 mx-12 bg-white">
            <h2 className="text-5xl font-semibold text-gray-900 pb-8">Lista de Posiciones</h2>
            <p className="text-2xl font-regular text-gray-500 mx-w-5xl leading-10">Tempor tellus in aliquet eu et sit nulla tellus. Suspendisse est, molestie blandit quis ac. Lacus. Quisque sapien nunc nisl eros. Facilisis sagittis maecenas id dignissim tristique proin sed.</p>
