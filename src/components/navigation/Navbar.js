//TODO ESTO ES MI ENCABEZADO
import { connect } from 'react-redux'
import { NavLink,Link } from 'react-router-dom'
import logo_emp from 'assets/img/oo.png'
//import cargandoGif from 'assets/img/cargandoGif.gif'
import { useState, Fragment } from 'react'
import { DotLoader } from 'react-spinners'
//Importando el desplazamiento de nuestro encabezado (Ajustable para movil)
        ...
        <nav data-scroll data-scroll-id="hey" id='navbar' className='w-full py-6 top-0 transition duration-300 ease-in-out z-40 fixed'>
            <div className="px-4 sm:px-6">
                <div className="-ml-4 -mt-2 hidden lg:flex flex-wrap items-center justify-between sm:flex-nowrap md:px-14 px-2">
                    ...
                    <img
                        src={'https://th.bing.com/th/id/R.7fc753f22fc9e0186605e63eb2f26135?rik=YaHCNQmkeWcmOw&pid=ImgRaw&r=0'}
                        width={160}
                        height={160}
                        className=""
                    />
                    ...
                    <Link
                        to="/contacto"
                        className="inline-flex ml-12 items-center rounded-md border border-transparent bg-orange-button px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-700 transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
                    >
                        Contactanos
