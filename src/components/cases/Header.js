//Componente El encabezado de casos
        ...
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-full xl:mx-12 xl:pt-24 xl:pb-36 lg:pt-40 lg:pb-48 pt-24 pb-12">
            <div>
              ...
              <div className="absolute inset-x-0 top-[calc(100%-20rem)] -z-10 transform-gpu overflow-hidden bg-white blur-lg lg:top-[calc(100%-42rem)] sm:top-[calc(100%-30rem)]">
