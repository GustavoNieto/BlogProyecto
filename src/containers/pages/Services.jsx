...
const posts_software = [
    ...
    {
      title: 'How to use search engine optimization to drive salesssssssgaaaaa',
      href: '#',
      img: coding_img, 
        ...
        <Layout>
            ...
            <Navbar/>
                <div className="pt-28">
                    ...
                    <ServicesList posts={posts_software} section_title={'¡Estamos preparados!'} />
